...
# UDAAN 1st Year Induction Toggle Script
...
if [ "$FIRST_YEAR_STATUS" = "true" ]; then
    echo "Current Status: ✅ 1ST YEAR INDUCTIONS ARE OPEN"
else
    echo "Current Status: ❌ 1ST YEAR INDUCTIONS ARE CLOSED"
fi
...
case $choice in
    ...
    2)
        ...
        echo ""
        echo "❌ 1st Year Inductions are now CLOSED!"
        ;;
    3)
        echo "Exiting..."
        exit 0
